...
@torch.no_grad()
def generate_completions(model, tokenizer, prompts, batch_size=1, flan_model=False, stop_id_sequences=None, add_special_tokens=True, disable_tqdm=False, **generation_kwargs):
    generations = []
    if not disable_tqdm:
